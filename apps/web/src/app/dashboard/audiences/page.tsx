...
import { Users, Search, Download, Filter, MoreHorizontal, Mail, Sparkles, Loader2 } from "lucide-react";
    ...
    <div className="max-w-6xl mx-auto w-full pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex gap-3">
          <button className="flex items-center gap-2 px-4 py-2 bg-white border-2 border-gray-200 rounded-xl font-bold font-comic text-gray-600 hover:border-[#333333] transition-colors">
            <Download className="w-4 h-4" /> Export CSV
          </button>
          <button className="flex items-center gap-2 px-4 py-2 bg-[#8B5CF6] text-white border-2 border-[#333333] rounded-xl font-bold font-balsamiq shadow-[4px_4px_0px_#333333] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_#333333] transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="bg-gradient-to-br from-[#8B5CF6] to-[#6D28D9] p-6 rounded-2xl border-2 border-[#333333] shadow-[4px_4px_0px_#333333] flex flex-col justify-center text-white relative overflow-hidden">
          ...
          <button className="self-start px-4 py-2 bg-white text-[#8B5CF6] rounded-lg font-bold text-sm shadow-sm hover:scale-105 transition-transform">
            Run Analysis
          </button>
        </motion.div>
      </div>
      ...
      <div className="bg-white rounded-2xl border-2 border-[#333333] shadow-[4px_4px_0px_#333333] overflow-hidden">
        ...
        <div className="p-4 border-b-2 border-gray-100 flex flex-col sm:flex-row gap-4 justify-between items-center bg-gray-50">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-white border-2 border-gray-200 rounded-xl font-bold font-comic text-gray-600 hover:bg-gray-50 transition-colors w-full sm:w-auto justify-center">
